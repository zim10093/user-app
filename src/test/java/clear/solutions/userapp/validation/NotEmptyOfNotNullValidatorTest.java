...
class NotEmptyOfNotNullValidatorTest {
    ...
    public void isValid_nullValue_ok() {
        Assertions.assertTrue(notEmptyOfNotNullValidator.isValid(null, constraintValidatorContext));
    }

    @Test
    public void isValid_notEmpty_ok() {
        Assertions.assertTrue(notEmptyOfNotNullValidator.isValid("not empty", constraintValidatorContext));
    }

    @Test
    public void isValid_Empty_notOk() {
        Assertions.assertFalse(notEmptyOfNotNullValidator.isValid("", constraintValidatorContext));
    }
}
